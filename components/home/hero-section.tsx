        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-white text-center lg:text-left">
            <h1 className="text-4xl font-switzer sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 leading-tight">
              <span className="block ">Vos travaux,</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link
                href="/a-propos"
                className="inline-flex items-center justify-center px-8 py-4 bg-[#B8D8D8] text-black font-semibold rounded-full hover:bg-[#7D9395] hover:text-white transition-all duration-300 text-lg"
              >
                À propos
              ...
              <Link
                href="/nos-services"
                className="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-black transition-all duration-300 text-lg"
              >
                Nos services
                <ChevronRight className="ml-2 w-5 h-5" />
              </Link>
